...
for (j in 2891:length(leaf.Del.Nig.Dos)) {
  ...
  # save pvalue file
  write_csv(model.pvalue, paste("../Pvalue_Leaf/", pheno.name, ".csv", sep = ""))
  ...
  dev.copy(png, paste("../Manhattan_Leaf/Manhattan_Deltoides_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
  # Nigra
