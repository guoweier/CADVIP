...
for (j in 2891:length(leaf.Del.Nig.Dos)) {
  ...
  # save pvalue file
  write_csv(model.pvalue, paste("../lm_Pvalue_Leaf/", pheno.name, ".csv", sep = ""))
  ...
  dev.copy(png, paste("../lm_Manhattan_Leaf/Manhattan_Deltoides_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
  # Nigra
  ...
  dev.copy(png, paste("../lm_Manhattan_Leaf/Manhattan_Nigra_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
  # Dosage
  ...
  dev.copy(png, paste("../lm_Manhattan_Leaf/Manhattan_Dosage_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
  # Nigra*Dosage
  ...
  dev.copy(png, paste("../lm_Manhattan_Leaf/Manhattan_Nigra_Dosage_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
}
