...
# Update 20220510: Change SNPs genomic positions to show the start and end SNPs locations. 
# Used for making physical map for creating a common marker map for P. deltoides and P. nigra and dosage. 
...
# record start and end positions of each bin (update 20220510)
for item in Pos:
...
header = "Chrom\tStart\tEnd\tStartPos\tEndPos"
