...
for (j in 959:length(leaf.Del)) {
  ...
  for (i in geno) {
    ...
    P.value <- c(colnames(deltoides_gt)[i],pvalue)
  ...
  # save pvalue file
  write_csv(model.pvalue, paste("../Pvalue_Leaf_D/", pheno.name, ".csv", sep = ""))
  ...
  dev.copy(png, paste("../Manhattan_Leaf_D/Manhattan_Deltoides_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
}
...
for (j in 959:length(leaf.Nig)) {
  ...
  for (i in geno) {
    ...
    P.value <- c(colnames(nigra_gt)[i],pvalue)
    model.pvalue <- rbind(model.pvalue,P.value)
  }
  model.pvalue <- model.pvalue %>% 
    filter(Marker != "Test") %>%
  ...
  # save pvalue file
  write_csv(model.pvalue, paste("../Pvalue_Leaf_N/", pheno.name, ".csv", sep = ""))
  ...
  dev.copy(png, paste("../Manhattan_Leaf_N/Manhattan_Nigra_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
}
...
for (j in 959:length(leaf.Dos)) {
  ...
  for (i in geno) {
    ...
    P.value <- c(colnames(dosage_gt)[i],pvalue)
    model.pvalue <- rbind(model.pvalue,P.value)
  }
  model.pvalue <- model.pvalue %>% 
    filter(Marker != "Test") %>%
  ...
  # save pvalue file
  write_csv(model.pvalue, paste("../Pvalue_Leaf_Dos/", pheno.name, ".csv", sep = ""))
  ...
  dev.copy(png, paste("../Manhattan_Leaf_Dos/Manhattan_Dosage_", pheno.name, ".png", sep = ""), width = 500, height = 300)
  dev.off()
}
